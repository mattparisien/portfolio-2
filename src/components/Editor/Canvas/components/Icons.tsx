...
export const SelectIcon = ({ width = 22, height = 22, pathClassName, svgClassName }: IconProps) => {
    return (
        <svg width={width} height={height} viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg" className={svgClassName}>
            <path d="M12.701 12.6399L19.333 10.3469C20.5762 9.91713 20.6178 8.17427 19.3965 7.6857L2.95369 1.10762C1.80982 0.650012 0.665618 1.76603 1.09456 2.92096L7.35821 19.7857C7.81593 21.0181 9.5581 21.0208 10.0197 19.7899L12.701 12.6399Z" className={pathClassName} strokeLinecap="round" strokeLinejoin="round" />
        </svg>
    )
}

export const TextIcon = ({ width = 15, height = 17, pathClassName, svgClassName }: IconProps) => {
    return (
        <svg width={width} height={height} viewBox="0 0 15 17" fill="none" xmlns="http://www.w3.org/2000/svg" className={svgClassName}>
            <path d="M4.08571 15.4H7.35294M7.35294 15.4H10.7714M7.35294 15.4V1M7.35294 1H2.02857C1.46051 1 1 1.46051 1 2.02857V3.54118M7.35294 1H12.2538C12.8218 1 13.2823 1.46051 13.2823 2.02857V3.96471" className={pathClassName} strokeLinecap="round" strokeLinejoin="round" />
        </svg>

    )
}

export const PencilIcon = ({ width = 22, height = 22, pathClassName, svgClassName }: IconProps) => {
    return (
        <svg width={width} height={height} viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg" className={svgClassName}>
            <path d="M3.4 14.2L7.6 17.8M2.8 14.2L14.6314 1.95543C15.9053 0.681526 17.9707 0.681524 19.2446 1.95542C20.5185 3.22932 20.5185 5.29472 19.2446 6.56863L7 18.4L1 20.2L2.8 14.2Z" className={pathClassName} strokeLinecap="round" strokeLinejoin="round" />
        </svg>
    )
}
...
export const CursorArrowIcon = ({ width = 15, height = 15, svgClassName, pathClassName }: { width?: number; height?: number; svgClassName?: string; pathClassName?: string }) => (
    <svg width={width} height={height} className={svgClassName} viewBox="0 0 317 354" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
...
export const TransparencyIcon = ({ width = 22, height = 22, pathClassName, svgClassName }: IconProps) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 24 24" className={svgClassName}><g fill="currentColor" fillRule="evenodd"><path d="M3 2h2a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1zm0 8h2a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1v-2a1 1 0 0 1 1-1zm0 8h2a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1v-2a1 1 0 0 1 1-1z"></path><path d="M11 2h2a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1h-2a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1zm0 8h2a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1h-2a1 1 0 0 1-1-1v-2a1 1 0 0 1 1-1zm0 8h2a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1h-2a1 1 0 0 1-1-1v-2a1 1 0 0 1 1-1z" opacity=".45"></path><path d="M19 2h2a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1h-2a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1zm0 8h2a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1h-2a1 1 0 0 1-1-1v-2a1 1 0 0 1 1-1zm0 8h2a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1h-2a1 1 0 0 1-1-1v-2a1 1 0 0 1 1-1z" opacity=".15"></path><path d="M7 6h2a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1V7a1 1 0 0 1 1-1zm0 8h2a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1v-2a1 1 0 0 1 1-1z" opacity=".7"></path><path d="M15 6h2a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1h-2a1 1 0 0 1-1-1V7a1 1 0 0 1 1-1zm0 8h2a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1h-2a1 1 0 0 1-1-1v-2a1 1 0 0 1 1-1z" opacity=".3"></path></g></svg>
    )
}