...
export const TextIcon = ({ width = 15, height = 17, strokeWidth = 2, stroke = "black" }: IconProps) => {
    return (
        <svg width={width} height={height} viewBox="0 0 15 17" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M4.08571 15.4H7.35294M7.35294 15.4H10.7714M7.35294 15.4V1M7.35294 1H2.02857C1.46051 1 1 1.46051 1 2.02857V3.54118M7.35294 1H12.2538C12.8218 1 13.2823 1.46051 13.2823 2.02857V3.96471" stroke={stroke} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
        </svg>
...
export const PencilIcon = ({ width = 22, height = 22, strokeWidth = 2, stroke = "black" }: IconProps) => {
    return (
        <svg width={width} height={height} viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M3.4 14.2L7.6 17.8M2.8 14.2L14.6314 1.95543C15.9053 0.681526 17.9707 0.681524 19.2446 1.95542C20.5185 3.22932 20.5185 5.29472 19.2446 6.56863L7 18.4L1 20.2L2.8 14.2Z" stroke={stroke} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
        </svg>
    )
}
...
export const SquareIcon = ({ width = 22, height = 22, strokeWidth = 2, stroke = "black" }: IconProps) => {
    return (
        <svg width={width} height={height} viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M16.6 1C18.5882 1 20.2 2.61178 20.2 4.6V16.6001C20.2 18.5883 18.5882 20.2001 16.6 20.2001H4.6C2.61177 20.2001 1 18.5883 1 16.6001L1 4.6C1 2.61177 2.61178 1 4.6 1L16.6 1Z" stroke={stroke} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
        </svg>
    )
}
...
export const TriangleIcon = ({ width = 22, height = 19, strokeWidth = 2, stroke = "black" }: IconProps) => {
    return (
        <svg width={width} height={height} viewBox="0 0 22 19" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M10.6 1L20.2 17.8H1L10.6 1Z" stroke={stroke} strokeWidth={strokeWidth} strokeLinejoin="round" />
        </svg>
...
export const LineIcon = ({ width = 22, height = 22, strokeWidth = 2, stroke = "black" }: IconProps) => {
    return (
        <svg width={width} height={height} viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M1 21L21 1" stroke={stroke} strokeWidth={strokeWidth} strokeLinecap="round" />
        </svg>
...
export const ChevronUpIcon = ({ width = 22, height = 22, strokeWidth = 2, stroke = "black", className }: IconProps) => {
    return (
        <svg width={width} height={height} viewBox="0 0 12 7" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
            <path d="M1 5.58344L6.00081 1L11 5.58344" stroke={stroke} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
        </svg>
...
export const TVIcon = ({ width = 22, height = 22, strokeWidth = 2, stroke = "black" }: IconProps) => {
    return (
        <svg width={width} height={height} viewBox="0 0 20 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M6.625 17L10 13.5714L13.375 17M3.25 13.5714H16.75C17.9926 13.5714 19 12.5481 19 11.2857V3.28571C19 2.02335 17.9926 1 16.75 1H3.25C2.00736 1 1 2.02335 1 3.28571V11.2857C1 12.5481 2.00736 13.5714 3.25 13.5714Z" stroke={stroke} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
        </svg>
...
export const CheckmarkIcon = ({ width = 22, height = 22, strokeWidth = 2, stroke = "black" }: IconProps) => {
    return (
        <svg width={width} height={height} viewBox="0 0 12 10" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M10.6 1L3.44048 8.2L1 5.74572" stroke={stroke} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
        </svg>
    )
}
...
export const CursorArrowIcon = ({ width = 15, height = 15, fill = "#1a1a1a", withStroke = true, style }: { width?: number; height?: number; fill?: string; withStroke?: boolean; style?: React.CSSProperties }) => (
...
export const StrokeWeightIcon = ({ width = 22, height = 22, strokeWidth = 2, stroke = "currentColor" }: IconProps) => {
    return (
        <svg width={width} height={height} fill="none" viewBox="0 0 24 24"><path fill={stroke} fillRule="evenodd" d="M6 6.5a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 0 1h-11a.5.5 0 0 1-.5-.5M7 10v1h10v-1zm-.25-1a.75.75 0 0 0-.75.75v1.5c0 .414.336.75.75.75h10.5a.75.75 0 0 0 .75-.75v-1.5a.75.75 0 0 0-.75-.75zM7 17v-2h10v2zm-1-2.25a.75.75 0 0 1 .75-.75h10.5a.75.75 0 0 1 .75.75v2.5a.75.75 0 0 1-.75.75H6.75a.75.75 0 0 1-.75-.75z" clipRule="evenodd"></path></svg>
    )   
}