...
export const TextIcon = ({ width = 15, height = 17, strokeWidth = 2, stroke = "black" }: IconProps) => {
    return (
        <svg width={width} height={height} viewBox="0 0 15 17" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M4.08571 15.4H7.35294M7.35294 15.4H10.7714M7.35294 15.4V1M7.35294 1H2.02857C1.46051 1 1 1.46051 1 2.02857V3.54118M7.35294 1H12.2538C12.8218 1 13.2823 1.46051 13.2823 2.02857V3.96471" stroke={stroke} strokeWidth={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
        </svg>
...
export const PencilIcon = ({ width = 22, height = 22, strokeWidth = 2, stroke = "black" }: IconProps) => {
    return (
        <svg width={width} height={height} viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M3.4 14.2L7.6 17.8M2.8 14.2L14.6314 1.95543C15.9053 0.681526 17.9707 0.681524 19.2446 1.95542C20.5185 3.22932 20.5185 5.29472 19.2446 6.56863L7 18.4L1 20.2L2.8 14.2Z" stroke={stroke} strokeWidth={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
        </svg>
    )
}
...
export const CircleIcon = ({ width = 22, height = 22, strokeWidth = 2, stroke = "black" }: IconProps) => {
    return (
        <svg width={width} height={height} viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M20.2 10.6C20.2 15.9019 15.9019 20.2 10.6 20.2C5.29807 20.2 1 15.9019 1 10.6C1 5.29807 5.29807 1 10.6 1C15.9019 1 20.2 5.29807 20.2 10.6Z" stroke={stroke} strokeWidth={strokeWidth} />
        </svg>
...
export const SquareIcon = ({ width = 22, height = 22, strokeWidth = 2, stroke = "black" }: IconProps) => {
    return (
        <svg width={width} height={height} viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M16.6 1C18.5882 1 20.2 2.61178 20.2 4.6V16.6001C20.2 18.5883 18.5882 20.2001 16.6 20.2001H4.6C2.61177 20.2001 1 18.5883 1 16.6001L1 4.6C1 2.61177 2.61178 1 4.6 1L16.6 1Z" stroke={stroke} strokeWidth={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
        </svg>
    )
}
...
export const TriangleIcon = ({ width = 22, height = 19, strokeWidth = 2, stroke = "black" }: IconProps) => {
    return (
        <svg width={width} height={height} viewBox="0 0 22 19" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M10.6 1L20.2 17.8H1L10.6 1Z" stroke={stroke} strokeWidth={strokeWidth} stroke-linejoin="round" />
        </svg>
...
export const LineIcon = ({ width = 22, height = 22, strokeWidth = 2, stroke = "black" }: IconProps) => {
    return (
        <svg width={width} height={height} viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M1 21L21 1" stroke={stroke} strokeWidth={strokeWidth} stroke-linecap="round" />
        </svg>
...
export const ChevronUpIcon = ({ width = 22, height = 22, strokeWidth = 2, stroke = "black", className }: IconProps) => {
    return (
        <svg width={width} height={height} viewBox="0 0 12 7" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
            <path d="M1 5.58344L6.00081 1L11 5.58344" stroke={stroke} strokeWidth={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
        </svg>

    )
}

export const LockOpenIcon = ({ width = 22, height = 22, strokeWidth = 2, className }: IconProps) => {
    return (
        <svg width={width} height={height} viewBox="0 0 17 22" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
            <path d="M2.575 6.48571C2.575 3.4468 4.98357 1 7.975 1C9.83842 1 11.4757 1.94943 12.4455 3.4M2.8 7.4C1.81 7.4 1 8.22286 1 9.22857V18.3714C1 19.3771 1.81 20.2 2.8 20.2H13.6C14.59 20.2 15.4 19.3771 15.4 18.3714V9.22857C15.4 8.22286 14.59 7.4 13.6 7.4H2.8Z" stroke="currentColor" strokeWidth={strokeWidth} stroke-linecap="round" />
        </svg>

    )
}

export const LockClosedIcon = ({ width = 22, height = 22, strokeWidth = 2, className }: IconProps) => {
    return (
        <svg width={width} height={height} viewBox="0 0 17 22" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
            <path d="M2.8 7.4V6.48571C2.8 3.4468 5.20857 1 8.2 1C11.1914 1 13.6 3.4468 13.6 6.48571V7.4M2.8 7.4C1.81 7.4 1 8.22286 1 9.22857V18.3714C1 19.3771 1.81 20.2 2.8 20.2H13.6C14.59 20.2 15.4 19.3771 15.4 18.3714V9.22857C15.4 8.22286 14.59 7.4 13.6 7.4M2.8 7.4H13.6" strokeWidth={strokeWidth} stroke-linecap="round" />
        </svg>
...
export const TrashIcon = ({ width = 22, height = 22, strokeWidth = 2 }: IconProps) => {
    return (
        <svg width={width} height={height} viewBox="0 0 18 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M1 4.17647H17M6 1H12M12.5 19H5.5C4.39543 19 3.5 18.0519 3.5 16.8824L3.0434 5.27937C3.01973 4.67783 3.47392 4.17647 4.04253 4.17647H13.9575C14.5261 4.17647 14.9803 4.67783 14.9566 5.27937L14.5 16.8824C14.5 18.0519 13.6046 19 12.5 19Z" stroke="black" strokeWidth={strokeWidth} stroke-linecap="round" />
        </svg>
    )
}
...
export const TVIcon = ({ width = 22, height = 22, strokeWidth = 2, stroke = "black" }: IconProps) => {
    return (
        <svg width={width} height={height} viewBox="0 0 20 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M6.625 17L10 13.5714L13.375 17M3.25 13.5714H16.75C17.9926 13.5714 19 12.5481 19 11.2857V3.28571C19 2.02335 17.9926 1 16.75 1H3.25C2.00736 1 1 2.02335 1 3.28571V11.2857C1 12.5481 2.00736 13.5714 3.25 13.5714Z" stroke={stroke} strokeWidth={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
        </svg>
...
export const CheckmarkIcon = ({ width = 22, height = 22, strokeWidth = 2, stroke = "black" }: IconProps) => {
    return (
        <svg width={width} height={height} viewBox="0 0 12 10" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M10.6 1L3.44048 8.2L1 5.74572" stroke={stroke} strokeWidth={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
        </svg>
    )
}
...
export const CursorArrowIcon = ({ width = 15, height = 15, fill = "#1a1a1a", style }: { width?: number; height?: number; fill?: string; style?: React.CSSProperties }) => (
