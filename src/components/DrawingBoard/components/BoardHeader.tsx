...
export default function BoardHeader({ isSyncing: _ }: BoardHeaderProps) {
  return (
    <div
      className="absolute top-5 left-0 sm:left-1/2 sm:-translate-x-1/2 px-4 py-1.5 rounded-full flex items-center gap-2 z-[400] select-none"
    >
      <div className="font-heading text-5xl mix-blend-exclusion md:text-6xl leading-[0.75] tracking-tight text-fg">Crumb</div>
